...
const commandPlan = [
  {
    label: 'Validate protected admin enquiry inbox triage foundation',
    cwd: repoRoot,
    args: ['run', 'validate:protected-admin-enquiry-inbox-triage-foundation'],
  },
  {
    label: 'Validate protected admin enquiry triage status update foundation',
    cwd: repoRoot,
  ...
  {
    label: 'Validate protected admin CRM handoff export review packet foundation',
    cwd: repoRoot,
    args: ['run', 'validate:protected-admin-crm-handoff-export-review-packet-foundation'],
  },
  {
    label: 'Validate protected admin CRM handoff packet audit manifest foundation',
    cwd: repoRoot,
    args: ['run', 'validate:protected-admin-crm-handoff-packet-audit-manifest-foundation'],
  },
  {
    label: 'Validate protected admin HubSpot import CSV handoff foundation',
    cwd: repoRoot,
    args: ['run', 'validate:protected-admin-hubspot-import-csv-handoff-foundation'],
  },
  {
    label: 'Validate protected admin HubSpot import CSV preflight quality foundation',
    cwd: repoRoot,
  ...
  {
    label: 'Validate maintenance closure audit follow-up response acknowledgement review outcome follow-up planning review readiness',
    cwd: repoRoot,
    args: ['run', 'validate:maintenance-closure-audit-follow-up-response-acknowledgement-review-outcome-follow-up-planning-review-readiness'],
  },
  {
    label: 'Validate maintenance closure audit follow-up response acknowledgement review outcome follow-up planning readiness',
    cwd: repoRoot,
    args: ['run', 'validate:maintenance-closure-audit-follow-up-response-acknowledgement-review-outcome-follow-up-planning-readiness'],
  },
  {
    label: 'Validate maintenance closure audit follow-up response acknowledgement review outcome readiness',
    cwd: repoRoot,
    args: ['run', 'validate:maintenance-closure-audit-follow-up-response-acknowledgement-review-outcome-readiness'],
  },
  {
    label: 'Validate maintenance closure audit follow-up response acknowledgement review readiness',
    cwd: repoRoot,
    args: ['run', 'validate:maintenance-closure-audit-follow-up-response-acknowledgement-review-readiness'],
  },
  {
    label: 'Validate maintenance closure audit follow-up response acknowledgement readiness',
    cwd: repoRoot,
    args: ['run', 'validate:maintenance-closure-audit-follow-up-response-acknowledgement-readiness'],
  },
  {
    label: 'Validate maintenance closure audit follow-up response dispatch readiness',
    cwd: repoRoot,
    args: ['run', 'validate:maintenance-closure-audit-follow-up-response-dispatch-readiness'],
  },
  {
    label: 'Validate maintenance closure audit follow-up response approval readiness',
    cwd: repoRoot,
    args: ['run', 'validate:maintenance-closure-audit-follow-up-response-approval-readiness'],
  },
  {
    label: 'Validate maintenance closure audit follow-up response planning readiness',
    cwd: repoRoot,
    args: ['run', 'validate:maintenance-closure-audit-follow-up-response-planning-readiness'],
  },
  {
