...
for (const requiredPath of docsPaths) {
  assert(fs.existsSync(path.join(repoRoot, requiredPath)), `Phase 6J doc missing ${requiredPath}`);
}
...
for (const required of [
  'Phase 6J-A/B adds maintenance closure audit follow-up response acknowledgement review readiness, an audit response acknowledgement review ledger, safe acknowledgement review language, and a no-review-decision/no-contact/no-remediation firewall',
...
console.log('Phase 6J maintenance closure audit follow-up response acknowledgement review readiness checks passed. No deployment was performed. No recipient or channel was configured. No audit response was dispatched, delivered, acknowledged, reviewed, accepted, or sent. No acknowledgement review decision was recorded. No acknowledgement request was sent. No remediation was assigned.');
