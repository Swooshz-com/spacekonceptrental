...
for (const required of [
  'Phase 6H-A/B adds maintenance closure audit follow-up response dispatch readiness, an audit response dispatch packet ledger template, safe response dispatch language, and a no-dispatch/no-send/no-remediation firewall',
