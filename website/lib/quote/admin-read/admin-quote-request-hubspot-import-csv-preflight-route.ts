...
type AdminQuoteRequestHubSpotImportCsvPreflightRouteEnv = {
  ADMIN_EXPECTED_ORIGIN?: string | null;
  ADMIN_EXPECTED_HOST?: string | null;
  ADMIN_TRUSTED_WORKSPACE_ID?: string | null;
};

export type AdminQuoteRequestHubSpotImportCsvPreflightRouteDependencies = {
  env?: AdminQuoteRequestHubSpotImportCsvPreflightRouteEnv;
  generatedAt?: () => string;
  now?: () => number;
...
function getRouteEnv(
  dependencies: AdminQuoteRequestHubSpotImportCsvPreflightRouteDependencies
) {
...
export async function handleAdminQuoteRequestHubSpotImportCsvPreflightRoute(
  request: NextRequest,
  dependencies: AdminQuoteRequestHubSpotImportCsvPreflightRouteDependencies = {}
