...
type AdminQuoteRequestCrmHandoffLifecycleReconciliationRouteEnv = {
  ADMIN_EXPECTED_ORIGIN?: string | null;
  ADMIN_EXPECTED_HOST?: string | null;
  ADMIN_TRUSTED_WORKSPACE_ID?: string | null;
};

export type AdminQuoteRequestCrmHandoffLifecycleReconciliationRouteDependencies = {
  env?: AdminQuoteRequestCrmHandoffLifecycleReconciliationRouteEnv;
  generatedAt?: () => string;
  now?: () => number;
...
function getRouteEnv(
  dependencies: AdminQuoteRequestCrmHandoffLifecycleReconciliationRouteDependencies
) {
...
export async function handleAdminQuoteRequestCrmHandoffLifecycleReconciliationRoute(
  request: NextRequest,
  dependencies: AdminQuoteRequestCrmHandoffLifecycleReconciliationRouteDependencies = {}
  ...
  return NextResponse.json(
    {
      ...
      reconciliation:
        generateAdminQuoteRequestCrmHandoffLifecycleReconciliation({
          ...
          preflight: generateAdminQuoteRequestHubSpotImportCsvPreflight(
            result.packet
          )
        })
    },
