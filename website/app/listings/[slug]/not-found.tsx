    ...
    <div className="section-padding">
      <div className="container">
        <div className="v3-empty-state">
          <svg width="48" height="48" viewBox={["0","0","24","24"].join(" ")} fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" style={{ margin: '0 auto 24px', color: 'var(--muted)', display: 'block' }}>
