...
function NextStepsPanel() {
  return <section className="stitch-quote-card stitch-quote-next"><p className="stitch-eyebrow">What happens next?</p><h2>What happens next?</h2><ol><li>Selected rental items</li><li>Event details</li><li>Manual team review</li><li>Email follow-up</li></ol></section>;
}
...
export default async function QuotePage({ searchParams }: QuotePageProps = {}) {
  ...
  return <><section className="stitch-quote-hero"><div className="stitch-container"><StitchPageIntro eyebrow="Request Quote" title="Request a Furniture Rental Quote" intro="A guided enquiry for selected rental items, event details, and contact details. The SpaceKonceptRental team reviews each request manually and follows up by email." /></div></section><section className="stitch-section stitch-quote-page"><div className="stitch-container"><div className="stitch-quote-layout"><div className="stitch-quote-left"><SelectionPanel product={context.product} requestedSlug={context.requestedSlug} category={context.category} event={context.event} search={context.search} /><NextStepsPanel /></div><section className="stitch-quote-form-panel"><h2>Guided enquiry details</h2><QuoteRequestForm initialItemsText={initialItemsText} initialListingSlug={context.requestedSlug} /></section></div></div></section></>;
}
