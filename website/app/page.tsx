...
import { StitchAdvantageCards, StitchCategoryPreview, StitchFeaturedPieces, StitchHomeHero } from "../components/PublicStitch";
...
export default async function HomePage() {
  ...
  return <><StitchHomeHero /><StitchAdvantageCards /><StitchCategoryPreview catalogue={catalogue} /><StitchFeaturedPieces catalogue={catalogue} /></>;
}
