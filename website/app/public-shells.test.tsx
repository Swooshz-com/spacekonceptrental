...
describe("public page shells", () => {
  ...
  it("uses an immediate public section glide assist instead of continuous CSS snapping", () => {
    ...
    expect(scrollAssistSource).toContain("linearThenEaseOut");
    expect(scrollAssistSource).toContain("window.scrollTo(0, startTop + distance * easedProgress)");
    expect(scrollAssistSource).toContain("forceInstantScrollBehavior");
    expect(scrollAssistSource).toContain("restoreScrollBehavior");
    expect(scrollAssistSource).toContain("document.documentElement.style.scrollBehavior = \"auto\"");
